...
export function SessionHeader(props: SessionHeaderProps) {
  ...
  return (
    ...
    >
      ...
      {/* Compact action cluster per asset pack: fullscreen + (detach if
          tmux) + close. Settings + restart live in the right-click menu
          to keep the header quiet. */}
      ...
      {props.onDetach && props.kind === 'tmux' && (
        <ControlButton
          ...
          title={`Detach — keeps running in tmux. Re-attach: tmux attach -t ${props.tmuxName ?? ''}`}
